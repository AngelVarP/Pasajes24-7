        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <header class="bg-white shadow-sm h-16 flex items-center justify-between px-6 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <h1 class="header-title text-2xl font-extrabold tracking-tight">Gestionar Viajes</h1>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @forelse ($viajes as $viaje)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $viaje->ruta->origen->nombre }} &rarr; {{ $viaje->ruta->destino->nombre }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $viaje->empresa->nombre }}</td>
