...
<body class="bg-white text-gray-900">
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="admin-sidebar w-64 text-gray-600 hidden md:flex md:flex-col fixed inset-y-0 z-50">
            ...
            {{-- Menú (Estandarizado con el Dashboard) --}}
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <header class="bg-white shadow-sm h-16 flex items-center justify-between px-6 border-b border-gray-200 sticky top-0 z-40">
                 <div class="flex items-center">
                    ...
                    {{-- Título actualizado --}}
                    <h1 class="header-title text-xl font-bold text-gray-900">Editar Viaje #{{ $viaje->id }}</h1>
                </div>
            ...
            <main class="flex-grow p-6 lg:p-10 bg-white">
                ...
                {{-- Formulario agrupado en un fondo slate-50 --}}
                <div class="bg-slate-50 p-6 md:p-8 rounded-lg border border-slate-200 w-full max-w-4xl mx-auto">
                    ...
                    <h2 class="text-2xl font-semibold text-gray-800 mb-6 border-b pb-4 border-gray-200 flex items-center">
                         <svg class="w-6 h-6 mr-3 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                    ...
                    <form action="{{ route('admin.viajes.update', $viaje) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT') {{-- ¡Lógica intacta! --}}

                        {{-- Fila 1: Ruta y Empresa --}}
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="ruta_id" class="block text-sm font-medium text-gray-700 mb-1">Ruta:</label>
                                <select name="ruta_id" id="ruta_id" required class="block w-full px-4 py-2 border border-gray-300 bg-white rounded-md shadow-sm sm:text-sm">
                            ...
                            <div>
                                ...
                                <select name="empresa_id" id="empresa_id" required class="block w-full px-4 py-2 border border-gray-300 bg-white rounded-md shadow-sm sm:text-sm">
                        ...
                        <div class="flex items-center justify-end pt-6 border-t border-gray-200 mt-8">
                            ...
                            {{-- Botón primario actualizado a naranja pastel --}}
