...
<head>
    ...
    {{-- Título adaptado para la ciudad --}}
    <title>Editar Ciudad: {{ $ciudad->nombre }} - Admin</title>

    {{-- Estilos (tomados de tu template base) --}}
        ...
        <aside class="admin-sidebar w-64 text-gray-300 hidden md:flex md:flex-col fixed inset-y-0 z-50 shadow-lg">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="#" class="flex items-center px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-700 hover:text-amber-500">
                 ...
                 {{-- Enlace de "Gestionar Ciudades" (Activo) --}}
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <header class="bg-white shadow-sm h-16 flex items-center justify-between px-6 border-b border-gray-200">
                 <div class="flex items-center">
                      ...
                      <h1 class="header-title text-2xl font-extrabold tracking-tight">Editar Ciudad</h1>
                 </div>
            ...
            <main class="flex-grow p-6 lg:p-10 main-content-bg">
                ...
                <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-2xl mx-auto">
                    ...
                    {{-- Usa la ruta 'admin.ciudades.update' y el modelo $ciudad para la URL --}}
                    <form action="{{ route('admin.ciudades.update', $ciudad) }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" required maxlength="100"
                                    {{-- Usamos old() o el valor de la base de datos si no hay errores --}}
                                    value="{{ old('nombre', $ciudad->nombre) }}" placeholder="Ej: Bogotá"
                                    class="block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-amber-500 focus:border-amber-500 sm:text-sm @error('nombre') input-error @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="departamento" id="departamento" required maxlength="100"
                                    value="{{ old('departamento', $ciudad->departamento) }}" placeholder="Ej: Cundinamarca"
                                    class="block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-amber-500 focus:border-amber-500 sm:text-sm @error('departamento') input-error @enderror">
