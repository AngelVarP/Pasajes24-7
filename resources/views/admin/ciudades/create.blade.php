...
<head>
    ...
    {{-- Estilos del Admin (Tomados de tu plantilla base) --}}
    <style>
        ...
        /* La clase 'active' se usará en el enlace de Gestionar Ciudades */
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <header class="bg-white shadow-sm h-16 flex items-center justify-between px-6 border-b border-gray-200">
                 <div class="flex items-center">
                      ...
                      <h1 class="header-title text-2xl font-extrabold tracking-tight">Crear Nueva Ciudad</h1>
                 </div>
            ...
            <main class="flex-grow p-6 lg:p-10 main-content-bg">
                ...
                <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-2xl mx-auto">
                    ...
                    {{-- Mensajes de Éxito y Error (Mismo estilo) --}}
                    @if (session('success'))
                    ...
                    <form action="{{ route('admin.ciudades.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" required maxlength="100"
                                    value="{{ old('nombre') }}" placeholder="Ej: Medellín"
                        ...
                        <div>
                            ...
                            <input type="text" name="departamento" id="departamento" required maxlength="100"
                                    value="{{ old('departamento') }}" placeholder="Ej: Antioquia"
