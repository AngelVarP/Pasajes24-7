        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <main class="flex-grow p-6 lg:p-10 main-content-bg">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    ...
                    <a href="#" class="admin-card flex flex-col p-6 bg-white rounded-xl shadow-lg border-b-4 border-blue-500 text-center items-center"><div class="p-4 rounded-full bg-blue-100 text-blue-600 mb-4 inline-block"><svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path></svg></div><h2 class="text-lg font-semibold text-gray-800 mb-1">Gestionar Viajes</h2><p class="text-gray-500 text-xs">Editar o cancelar.</p></a>
