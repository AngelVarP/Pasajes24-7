...
{{-- **FORMULARIO DE FILTROS** (Ruta, Fecha de Salida, Empresa) --}}
    ...
    <form action="{{ route('admin.reservas.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        ...
        <div>
            ...
            <input type="date" name="fecha_salida" id="fecha_salida" 
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm focus:ring-amber-500 focus:border-amber-500">
        </div>

        {{-- Filtro por Empresa --}}
        <div>
            <label for="empresa_id" class="block text-sm font-medium text-gray-700 mb-1">Filtrar por Empresa:</label>
            <select name="empresa_id" id="empresa_id" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm focus:ring-amber-500 focus:border-amber-500">
